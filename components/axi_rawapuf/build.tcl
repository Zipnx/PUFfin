...
#
# build2.tcl: Tcl script for re-creating project 'axi_rawapuf'
#
# Generated by Vivado on Fri Aug 15 02:14:08 +0300 2025
...
#
#    "D:/Programs/Vivado/puffin/components/axi_rawapuf/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/Programs/Vivado/puffin/components/axi_rawapuf/vhd/APUF_Raw_AXI_v1_0_S00_AXI.vhd"
#    "D:/Programs/Vivado/puffin/components/axi_rawapuf/vhd/APUF_Raw_AXI_v1_0.vhd"
#    "D:/Programs/Vivado/puffin/iprepo/axi_rawapuf/component.xml"
#
#*****************************************************************************************

# you cannot fathom the pain ive experienced from this
...
set _xil_proj_name_ "axi_rawapuf"
...
set orig_proj_dir "[file normalize "$origin_dir/axi_rawapuf"]"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/vhd/APUF_Raw_AXI_v1_0_S00_AXI.vhd"] \
 [file normalize "${origin_dir}/vhd/APUF_Raw_AXI_v1_0.vhd"] \
 [file normalize "${origin_dir}/../../iprepo/axi_rawapuf/component.xml"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/vhd/APUF_Raw_AXI_v1_0_S00_AXI.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/vhd/APUF_Raw_AXI_v1_0.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../iprepo/axi_rawapuf/component.xml"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
#set obj [get_filesets sources_1]
#set_property -name "top" -value "APUF_Raw_AXI_v1_0" -objects $obj

# Set 'sources_1' fileset object
#set obj [get_filesets sources_1]
# Import local files from the original project
#set files [list \
# [file normalize "${origin_dir}/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci" ]\
#]
...
# Set 'sources_1' fileset file properties for local files
#set file "raw_apuf_0/raw_apuf_0.xci"
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# ================================================================
# EDIT: Need to first generate the XCI because i hate everything that has ever happened to
#       lead me here, it is 2am
# ================================================================

file mkdir $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip
create_ip -name raw_apuf -vendor xilinx.com -library user -version 1.0 -module_name raw_apuf_0 -dir $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip
generate_target {instantiation_template} [get_files $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci]
update_compile_order -fileset sources_1
generate_target all [get_files  $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci]

catch { config_ip_cache -export [get_ips -all raw_apuf_0] }
export_ip_user_files -of_objects [get_files $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci] -no_script -sync -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci]
launch_runs -jobs 4 raw_apuf_0_synth_1

# this is prob fine to be excluded
#export_simulation -of_objects [get_files $origin_dir/axi_rawapuf/axi_rawapuf.srcs/sources_1/ip/raw_apuf_0/raw_apuf_0.xci] -directory $origin_dir/axi_rawapuf/axi_rawapuf.ip_user_files/sim_scripts -ip_user_files_dir $origin_dir/axi_rawapuf/axi_rawapuf.ip_user_files -ipstatic_source_dir $origin_dir/axi_rawapuf/axi_rawapuf.ip_user_files/ipstatic -lib_map_path [list {modelsim=$origin_dir/axi_rawapuf/axi_rawapuf.cache/compile_simlib/modelsim} {questa=$origin_dir/axi_rawapuf/axi_rawapuf.cache/compile_simlib/questa} {riviera=$origin_dir/axi_rawapuf/axi_rawapuf.cache/compile_simlib/riviera} {activehdl=$origin_dir/axi_rawapuf/axi_rawapuf.cache/compile_simlib/activehdl}] -use_ip_compiled_libs -force -quiet
